...
/*  write some code that declares two varibles, character and 
  timesToRepeat.
    Using a loop, repeat that character many time and then console.log
  it.

   Example. if I had character = 'Bb'; and timesToRepeat = 5, it'd console.log
  'BbBbBbBbBb'
